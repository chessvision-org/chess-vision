...
function AuthActions({
  ...
  if (isAuthenticated) {
    return html`<button type="button" data-signout class="menu-item-danger">
      <span class="${iconClass}">${LogOut()}</span
          ...
          <a href="/" class="logo-btn" aria-label="ChessViewer home">
            <span class="logo-inner">
              ...
              <span class="logo-text-wrap"
                ><span class="logo-text">ChessViewer</span></span
              >
            </span>
          </a>
          ...
          <div class="desktop-menu-wrap">
            ...
            <div class="desktop-dropdown-wrap" id="desktop-dropdown-wrap">
              <button
                ...
                aria-haspopup="menu"
              >
                <span class="toggle-icon" data-nav-icon="open"
                  >${UserCircle()}</span
                >
                <span class="toggle-icon hidden" data-nav-icon="close"
                  >${X()}</span
                >
              </button>
        ...
        <div class="mobile-content">
          ...
          <div class="menu-section">
            ${NavLink({
              ...
              icon: Settings,
              label: 'Settings',
              iconClass: 'menu-icon menu-icon-lg menu-icon-inherit'
            })}
            ${NavLink({
              href: '/about',
              icon: Info,
